...
var ListAllProductsService = /** @class */ (function () {
    function ListAllProductsService() {
    }
    ListAllProductsService.prototype.execute = function (_a) {
        var ProductsLength = _a.ProductsLength, id = _a.id;
