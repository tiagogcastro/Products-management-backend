...
var UpdateUserService = /** @class */ (function () {
    ...
    UpdateUserService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var usersRepository, findUser, user, userUpdated;
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (email === findUser.email && name === findUser.name) {
                            throw new AppError_1.default('Você não mudou nenhuma informação para atualizar seu usuário.');
                        }
                        return [4 /*yield*/, usersRepository.update(id, {
                                email: email,
                                name: name,
                                updated_at: new Date()
                            })];
                    ...
                    case 4: throw new AppError_1.default('Você não está logado.');
                }
            });
        });
    };
